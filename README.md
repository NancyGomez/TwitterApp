...
1. How do you avoid initialization of a member variable? Or declaring it's type?
2. Is there a way to have back buttons with tab bar view controller? Or does that not make sense.
...
Most of my challenges are always about UI stuff, so the navigation controller back button wasn't working. Scrapped the navigation view controller and lo and behold my back button appears.
